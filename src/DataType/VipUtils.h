...
/// @return true on success, false otherwise
VIP_DATA_TYPE_EXPORT bool vipResampleVectors(VipPointVector & a, VipPointVector & b,
	ResampleStrategies s = ResampleIntersection | ResampleInterpolation, vip_double padd_a = 0, vip_double padd_b = 0);
...
/// @param padd_b padding Y value when using ResampleUnion for vector b
/// @return true on success, false otherwise
VIP_DATA_TYPE_EXPORT bool vipResampleVectors(VipComplexPointVector & a, VipComplexPointVector & b,
	ResampleStrategies s = ResampleIntersection | ResampleInterpolation, complex_d padd_a = 0, complex_d padd_b = 0);
...
/// @param padd_b padding Y value when using ResampleUnion for vector b
/// @return true on success, false otherwise
VIP_DATA_TYPE_EXPORT bool vipResampleVectors(VipPointVector & a, VipComplexPointVector & b,
	ResampleStrategies s = ResampleIntersection | ResampleInterpolation, vip_double padd_a = 0, complex_d padd_b = 0);
...
/// @return true on success, false otherwise
VIP_DATA_TYPE_EXPORT bool vipResampleVectors(QList<VipPointVector> & lst,
	ResampleStrategies s = ResampleIntersection | ResampleInterpolation, vip_double padd = 0);
...
/// @param padd padding Y value when using ResampleUnion for all vectors
/// @return true on success, false otherwise
VIP_DATA_TYPE_EXPORT bool vipResampleVectors(QList<VipComplexPointVector> & lst,
	ResampleStrategies s = ResampleIntersection | ResampleInterpolation, complex_d padd = 0);
...
/// @return true on success, false otherwise
VIP_DATA_TYPE_EXPORT bool vipResampleVectors(QList<VipPointVector> & lst_a, QList<VipComplexPointVector> & lst_b,
	ResampleStrategies s = ResampleIntersection | ResampleInterpolation, vip_double padd_a = 0, complex_d padd_b = 0);
...
/// @return true on success, false otherwise
VIP_DATA_TYPE_EXPORT bool vipResampleVectors(QList<VipPointVector> & lst, vip_double x_step,
	ResampleStrategies s = ResampleIntersection | ResampleInterpolation, vip_double padd = 0);
