...
public:
    ...
    VipInterval();
    VipInterval( vip_double minValue, vip_double maxValue,
        BorderFlags = IncludeBorders );

    void setInterval( vip_double minValue, vip_double maxValue,
        BorderFlags = IncludeBorders );
...
inline VipInterval::VipInterval(
        vip_double minValue, vip_double maxValue, BorderFlags borderFlags ):
    d_minValue( minValue ),
    d_maxValue( maxValue ),
...
/// \param maxValue Maximum value
/// \param borderFlags Include/Exclude borders
inline void VipInterval::setInterval(
    vip_double minValue, vip_double maxValue, BorderFlags borderFlags )
{
    d_minValue = minValue;
    d_maxValue = maxValue;
...
///
/// \sa intersect()
inline VipInterval VipInterval::operator&(
    const VipInterval &other ) const
{
...
//! Constructor
inline VipIntervalSample::VipIntervalSample(
        vip_double v, const VipInterval &intv ):
    value( v ),
    interval( intv )
{
}
...
//! Constructor
inline VipIntervalSample::VipIntervalSample(
        vip_double v, vip_double min, vip_double max ):
    value( v ),
    interval( min, max )
{
}
...
//! Compare operator
inline bool VipIntervalSample::operator==(
    const VipIntervalSample &other ) const
{
