...
public:
	...
	virtual void onComputeScaleDiv(VipAbstractScale * scale, const VipInterval & items_interval) {
		(void)scale; (void)items_interval;
	}
...
///
    ...
    virtual void autoScale( int maxNumSteps,
        vip_double &x1, vip_double &x2, vip_double &stepSize ) const = 0;
...
///
    ...
    ///            calculates one.
    virtual VipScaleDiv divideScale( vip_double x1, vip_double x2,
        int maxMajSteps, int maxMinSteps,
        vip_double stepSize = 0.0 ) const = 0;
...
protected:
    ...
    void buildTicks(
        const VipInterval &, vip_double stepSize, int maxMinSteps,
		VipScaleDiv::TickList ticks[VipScaleDiv::NTickTypes] ) const;

	VipScaleDiv::TickList buildMajorTicks(
        const VipInterval &interval, vip_double stepSize ) const;

    void buildMinorTicks(
        const VipScaleDiv::TickList& majorTicks,
        int maxMinMark, vip_double step,
		VipScaleDiv::TickList &, VipScaleDiv::TickList & ) const;
};
...
protected:
	...
	VipScaleDiv::TickList buildMinorTicks(
        const VipScaleDiv::TickList& majorTicks,
        int maxMinMark, vip_double step ) const;
};
