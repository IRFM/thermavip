...
VipTipLabel::VipTipLabel(VipTipContainer * parent)
	:QLabel(parent), container(parent), expireTimeMs(-1)
{
...
VipTipContainer::VipTipContainer(const QString &text, QWidget *w, int msecDisplayTime, bool is_fake)
    : QWidget(w, Qt::ToolTip | Qt::BypassGraphicsProxyWidget | Qt::FramelessWindowHint), styleSheetParent(0),fake(is_fake), widget(0)
{
