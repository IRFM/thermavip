...
public:
    ...
    virtual QRgb rgb( const VipInterval &interval,
    ...
    virtual unsigned char colorIndex(
        const VipInterval &interval, double value ) const = 0;
...
public:
    ...
    VipLinearColorMap( const QColor &from, const QColor &to,
        VipColorMap::Format = VipColorMap::RGB );
    ...
    virtual unsigned char colorIndex(
        const VipInterval &, double value ) const;
...
inline QColor VipColorMap::color(
