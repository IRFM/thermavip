...
public:
    ...
    static void drawColorBar( QPainter *painter,
        ...
        const VipScaleMap &, Qt::Orientation, const QRectF &,
		QPixmap * pixmap = NULL);
    ...
    static void drawText(QPainter * painter, const VipCoordinateSystemPtr & m,
    		const VipText & text,
			double textRotation,
...
inline void VipPainter::drawLine( QPainter *painter,
