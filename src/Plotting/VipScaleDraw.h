#ifndef VIP_ABSTRACT_SCALE_DRAW_H
#define VIP_ABSTRACT_SCALE_DRAW_H
...
struct VipScaleText
{
	...
	: text(text), value(v), tr(tr), tick(tick) {}
};
...
VIP_PLOTTING_EXPORT QTransform textTransformation(
	VipAbstractScaleDraw::TextTransform textTransform, VipAbstractScaleDraw::TextPosition textPosition,
    double angle, const QPointF &pos, const QSizeF &size );
