...
public:
	...
	static QList<VipInterval> dataBoundingRect(const VipPointVector & samples, QList<VipPointVector> & vectors, QList<bool> & continuous, bool & full_continuous, bool & sub_continuous, const QPainterPath & shape = QPainterPath(), int shape_coord = 0);
