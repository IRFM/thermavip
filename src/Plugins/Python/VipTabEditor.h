...
class PYTHON_EXPORT VipTextSearchBar : public QToolBar
{
	Q_OBJECT
...
class PYTHON_EXPORT VipDefaultTextBar : public QToolBar
{
...
///
class PYTHON_EXPORT VipTabEditor : public QWidget
{
	Q_OBJECT
...
public:
	...
	/// @brief Returns true if this editor displays only one VipTextEditor
	/// (in which case the tab bar is hidden)
