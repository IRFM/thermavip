...
try:
    ...
    def call_thermavip_fun(name, args, kwargs = {}):
    ...
    def unloadThermavip():
        print("unloadThermavip\n");sys.__stdout__.write("unloadThermavip\n");sys.__stdout__.flush();sys.stdout.flush()
        f = open(r"C:\src\QI\Thermavip\bin_64\debug\Python\test.txt","w")
        f.write("toto")
        f.close()
        global _SharedMemory
        del _SharedMemory
...
def player_type(player):
    ...
    """
    return call_thermavip_fun('builtins.internal.player_type',(player,))
...
def item_list(player, selection = 2, name=str()):
    ...
    """
    return call_thermavip_fun('builtins.internal.item_list',(player,selection,name))
...
def set_selected(player, selected , name=str()):
    ...
    """
    return call_thermavip_fun('builtins.internal.set_selected',(player,selected,name))

def unselect_all(player):
    """
    Unselect all items in given player.
    """
    return call_thermavip_fun('builtins.internal.unselect_all',(player,))
...
def query(title = str(), default_value = str()):
    ...
    """
    return call_thermavip_fun('builtins.internal.query',(title,default_value))
...
def open(path, player = 0, side = ""):
    ...
    """
    return call_thermavip_fun('builtins.internal.open',(path,player,side))
...
def close(player):
    ...
    """
    return call_thermavip_fun('builtins.internal.close',(player,))

def show(player):
    """
    Restaure the state of a player that was maximized or minimized.
    """
    return call_thermavip_fun('builtins.internal.show_normal',(player,))

def maximize(player):
    """
    Show maximized given player.
    """
    return call_thermavip_fun('builtins.internal.show_maximized',(player,))

def minimize(player):
    """
    Minimize given player.
    """
    return call_thermavip_fun('builtins.internal.show_minimized',(player,))
...
def workspace(wks = 0):
    ...
    """
    return call_thermavip_fun('builtins.internal.workspace',(wks,))

def workspaces():
    """
    Returns the list of all available workspaces.
    """
    return call_thermavip_fun('builtins.internal.workspaces',())

def current_workspace():
    """
    Returns the ID of current workspace.
    """
    return call_thermavip_fun('builtins.internal.current_workspace',())

def workspace_title(wks):
    """
    Returns the workspace title for given workspace id
    """
    return call_thermavip_fun('builtins.internal.workspace_title',(wks,))

def set_workspace_title(wks, title):
    """
    Set the workspace title for given workspace id
    """
    return call_thermavip_fun('builtins.internal.set_workspace_title',(wks,title))

def resize_workspace():
    """
    Resize all windows in the current workspace
    """
    return call_thermavip_fun('builtins.internal.resize_workspace',())

def set_time_markers(start, end):
    """
    Set the current workspace time markers
    """
    return call_thermavip_fun('builtins.internal.set_time_markers',(start,end))
    
def remove_time_markers():
    """
    Remove the time markers from the current workspace
    """
    return call_thermavip_fun('builtins.internal.remove_time_markers',())

def time():
    """
    Returns the current time in nanoseconds within the current workspace.
    """
    return call_thermavip_fun('builtins.internal.time',())
...
def set_time(time, ref = 'absolute'):
    ...
    """
    return call_thermavip_fun('builtins.internal.set_time',(time,ref))
...
def next_time(time):
    ...
    """
    return call_thermavip_fun('builtins.internal.next_time',(time,))
...
def previous_time(time):
    ...
    """
    return call_thermavip_fun('builtins.internal.previous_time',(time,))
...
def closest_time(time):
    ...
    """
    return call_thermavip_fun('builtins.internal.closest_time',(time,))
...
def time_range():
    ...
    """
    return call_thermavip_fun('builtins.internal.time_range',())
...
def clamp_time( xy, min_time, max_time):
    ...
    """
    return call_thermavip_fun('builtins.internal.clamp_time',(xy,min_time,max_time))
...
def set_stylesheet(player, stylesheet, data_name = ""):
    ...
    """
    return call_thermavip_fun('builtins.internal.set_stylesheet',(player, stylesheet,data_name))
...
def top_level(player):
    ...
    """
    return call_thermavip_fun('builtins.internal.top_level',(player,))
...
def get(player, data_name = ""):
    ...
    """
    return call_thermavip_fun('builtins.internal.get',(player,data_name))
...
def get_attribute(player, attribute_name, data_name = ""):
    ...
    """
    return call_thermavip_fun('builtins.internal.get_attribute',(player,attribute_name,data_name))
...
def get_attributes(player, data_name = ""):
    ...
    first item data found is retuned. Note that only a partial name is required.
    """
    return call_thermavip_fun('builtins.internal.get_attributes',(player,data_name))
...
def set_attribute(player, attribute_name, attribute_value, data_name = ""):
    ...
    first item data found is retuned. Note that only a partial name is required.
    """
    return call_thermavip_fun('builtins.internal.set_attribute',(player,attribute_name,attribute_value, data_name))
...
def get_roi(player, group, roi_id, yaxis = ""):
    ...
    """
    return call_thermavip_fun('builtins.internal.get_roi',(player,group,roi_id,yaxis))
...
def get_roi_bounding_rect(player, group, roi_id, yaxis = ""):
    ...
    For plot player only, yaxis specifies on which left scale to search for the ROI (in case of stacked plots).
    """
    return call_thermavip_fun('builtins.internal.get_roi_bounding_rect',(player,group,roi_id,yaxis))
...
def get_roi_filled_points(player, group, roi_id):
    ...
    and ROI identifier.
    """
    return call_thermavip_fun('builtins.internal.get_roi_filled_points',(player,group,roi_id))
...
def clear_roi(player, yaxis = ""):
    ...
    For plot player only, yaxis specifies on which left scale to search for the ROI (in case of stacked plots).
    """
    return call_thermavip_fun('builtins.internal.clear_roi',(player,yaxis))
...
def add_roi(player, roi,yaxis = ""):
    ...
    """
    return call_thermavip_fun('builtins.internal.add_roi',(player,roi,yaxis))
...
def add_ellipse(player, ellipse, yaxis = ""):
    ...
    Returns a string containing 'group:roi_id'.
    """
    return call_thermavip_fun('builtins.internal.add_ellipse',(player,ellipse,yaxis))
...
def add_circle(player, y, x, radius, yaxis = ""):
    ...
    Returns a string containing 'group:roi_id'.
    """
    return call_thermavip_fun('builtins.internal.add_circle',(player,y,x,radius,yaxis))
...
def time_trace(roi_player, rois, **kwargs ):
    ...
    """
    return call_thermavip_fun('builtins.internal.time_trace',(roi_player,rois,kwargs))
...
def remove(player, data_name):
    ...
    """
    return call_thermavip_fun('builtins.internal.remove',(player,data_name))

def set_time_marker(player, enable):
    """
    Show/hide the time marker for given plot player.
    """
    return call_thermavip_fun('builtins.internal.set_time_marker',(player,enable))
...
def set_row_ratio(row, ratio):
    ...
    """
    return call_thermavip_fun('builtins.internal.set_row_ratio',(row,ratio))
...
def zoom(player, x1, x2, y1 = 0, y2 = 0, unit = ""):
    ...
    """
    return call_thermavip_fun('builtins.internal.zoom',(player,x1,x2,y1,y2,unit))
...
def set_color_map_scale(player, vmin, vmax, gripMin = 0, gripMax = 0):
    ...
    """
    return call_thermavip_fun('builtins.internal.set_color_map_scale',(player,vmin,vmax,gripMin,gripMax))
...
def x_range(player):
    ...
    """
    return call_thermavip_fun('builtins.internal.x_range',(player))

def auto_scale(player, enable):
    """
    Enable/disable automatic scaling for given player
    """
    return call_thermavip_fun('builtins.internal.auto_scale',(player, enable))

def set_x_scale(player, minvalue, maxvalue):
    """
    Set the min and max value of the bottom scale for given plot player
    """
    return call_thermavip_fun('builtins.internal.set_x_scale',(player, minvalue, maxvalue))
...
def set_y_scale(player, minvalue, maxvalue, unit=""):
    ...
    """
    return call_thermavip_fun('builtins.internal.set_y_scale',(player, minvalue, maxvalue,unit))
...
def player_range(player):
    ...
    """
    return call_thermavip_fun('builtins.internal.player_range',(player,))

def set_title(player,title):
    """
    Set the given player title.
    """
    return call_thermavip_fun('builtins.internal.set_title',(player,title))
...
def annotation(player,style,text,pos,**kwargs):
    ...
    """
    return call_thermavip_fun('builtins.internal.annotation',(player,style,text,pos,kwargs))

def remove_annotation(annotation_id):
    """
    Remove annotation with given id
    """
    return call_thermavip_fun('builtins.internal.remove_annotation',(annotation_id))
...
def clear_annotations(player, all_annotations = False):
    ...
    """
    return call_thermavip_fun('builtins.internal.clear_annotations',(player,all_annotations))
...
def imshow(array,**kwargs):
    ...
    """
    return call_thermavip_fun('builtins.internal.imshow',(array,kwargs))
...
def plot(xy,**kwargs):
    ...
    """
    return call_thermavip_fun('builtins.internal.plot',(xy,kwargs))
...
def plots(xys,**kwargs):
    ...
    """	
    return call_thermavip_fun('builtins.internal.plots',(xys,kwargs))
...
def add_function(player, fun, function_name, item_name = str()):
    ...
    """
    return call_thermavip_fun('builtins.internal.add_function',(player, fun, function_name, item_name))

def get_function(player, function_name, item_name = str()):
    """
    Returns a function object set with add_function
    """
    return call_thermavip_fun('builtins.internal.get_function',(player, function_name, item_name))
...
def resample(signals, strategy = "union", step = 0, padd=0):
    ...
    x values.
    """
    return call_thermavip_fun('builtins.internal.resample',(signals, strategy, step,padd))
...
def user_input(title, *args):
    ...
    """
    return call_thermavip_fun('builtins.internal.user_input',(title, *args))
...
def call_internal_func(name, *args):
    """
    Call a Thermavip function registered with vipRegisterFunction
    """
    return call_thermavip_fun('builtins.internal.call_internal_func',(name,) + args)
...
def reorganize():
    ...
    """
    try:
        return call_internal_func('reorganizeCurrentWorkspace')
    except:
        return call_thermavip_fun('builtins.internal.reorganize',())
...
def set_workspace_max_columns(max_cols):
    ...
    """
    return call_internal_func('setCurrentWorkspaceMaxColumns',max_cols)
    
def workspace_max_columns():
    """
    Returns the maximum column size for the current workspace.
    """
    return call_internal_func('currentWorkspaceMaxColumns')
    
def current_pulse():
    """
    Returns the current selected pulse number
    """
    return call_internal_func('getCurrentPulse')