...
if (WIN32)
	...
	file(GLOB SHARED_LIBS LIST_DIRECTORIES true  "${PYTHON_RUNTIME}/*.dll" "${PYTHON_RUNTIME}/*.so" "${PYTHON_RUNTIME}/*.so.*")
...
file(COPY ${CMAKE_SOURCE_DIR}/src/Plugins/Python/Python DESTINATION ${CMAKE_INSTALL_PREFIX}/thermavip/)