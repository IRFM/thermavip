...
public:
	...
	typedef int (*_ts_pulse_infos)(int pulse, double* duration,
		double* IP, double* IP_t,
		double* LH1, double* LH1_t,
		double* LH2, double* LH2_t,
		double* LHT, double* LHT_t,
		double* ICR1, double* ICR1_t,
		double* ICR2, double* ICR2_t,
		double* ICR4, double* ICR4_t,
		double* ICRT, double* ICRT_t,
		double* MaxPow, double* MaxPow_t,
		double* TotEnergy,
		char* config, char *date, double* disruption);
	...
	typedef  int (*_get_ir_config_infos)(int pulse, const char * view,
		char * dir, int * fpga, char * cam, int * flip_rl, int * flip_ud,
		char * roi, char * lut, char * trhub, char * trfut, char * trmir, char * lopt);
