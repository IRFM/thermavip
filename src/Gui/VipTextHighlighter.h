...
///
class VIP_GUI_EXPORT VipTextHighlighter : public QSyntaxHighlighter
{
	Q_OBJECT
...
///
class VIP_GUI_EXPORT VipPyBaseHighlighter : public VipTextHighlighter
{
	Q_OBJECT
...
struct VIP_GUI_EXPORT VipPyDevScheme : VipPyBaseHighlighter
{
...
struct VIP_GUI_EXPORT VipPyDarkScheme : VipPyBaseHighlighter
{
...
struct VIP_GUI_EXPORT VipSpyderDarkScheme : VipPyBaseHighlighter
{
...
struct VIP_GUI_EXPORT VipPyZenburnScheme : VipPyBaseHighlighter
{
...
struct VIP_GUI_EXPORT VipTextScheme : VipTextHighlighter
{
